...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified confirmImageLbl;
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified instructionsImage;
